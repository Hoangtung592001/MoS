const localizations = {
    ...
    followMoSBooks: 'Follow AbeBooks',
    facebook: 'Facebook',
    twitter: 'Twitter',
    instagram: 'Instagram',
    youtube: 'Youtube',
    ...
    newToMosBooks: 'New to AbeBooks?',
    createYourMosBooksAccount: 'Create Your AbeBooks Account',
    ...
    saveThisPayment: 'Save this payment method for future purchases',
